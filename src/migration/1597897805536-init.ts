...
export class init1597897805536 implements MigrationInterface {
    name = 'init1597897805536'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `organization` (`id` varchar(36) NOT NULL, `name` varchar(255) NOT NULL, `brief` text NOT NULL, `status` enum ('active', 'deactive') NOT NULL DEFAULT 'active', `website` varchar(255) NOT NULL, `mailext` text NOT NULL, `member` tinyint NOT NULL, `peopleId` int NULL, `projectId` varchar(36) NULL, `technologyId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `person` (`id` int NOT NULL AUTO_INCREMENT, `expertise` text NOT NULL, `COVID_19` tinyint NOT NULL, `userId` varchar(36) NULL, `belongOrganizationId` varchar(36) NULL, UNIQUE INDEX `REL_83b775da14886d352de2a4cac0` (`userId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `contact` (`id` varchar(36) NOT NULL, `title` enum ('Mr', 'Miss', 'Dr', 'Mrs', 'Ms', '') NOT NULL DEFAULT '', `first_name` varchar(255) NOT NULL, `last_name` varchar(255) NOT NULL, `job_title` varchar(255) NOT NULL, `email` varchar(255) NOT NULL, `member` tinyint NOT NULL, `country` varchar(255) NOT NULL, `state` varchar(255) NOT NULL, `personId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
